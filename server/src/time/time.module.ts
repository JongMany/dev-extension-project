...
import {
  TimeSchema,
  TimeSchemaModel,
} from 'src/time/domain/schema/time.schema';
...
@Module({
  ...
  providers: [
    { useClass: TimeService, provide: TimeServicePort },
    { useClass: TimeRepository, provide: TimeRepositoryPort },
    TimeRepository,
  ],
  controllers: [TimeController],
  exports: [TimeRepositoryPort],
})
